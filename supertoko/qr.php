...
<body>
        ...
        Vue.component('scanner', {
            ...
            mounted: function() {
                ...
                function onScanSuccess(decodedText, decodedResult) {
                    // Emit the decoded product ID
                    $this.$root.$emit('decodedCode', decodedText);
                }
    ...
    created: function () {
        this.$root.$on('decodedCode', function (decodedText) {
            // Redirect to detail.php with the product ID
            window.location.href = '?url=scan&id_product=' + decodedText;
        });
    }
});
