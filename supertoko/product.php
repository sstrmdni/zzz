                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                ...
                                <a href="index.php?url=addnewtoko" class="btn btn-primary mt-3">Add</a>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row justify-content-center">
                            <div class="col-auto">
                                <div class="icon icon-shape bg-gradient-primary shadow-primary text-center rounded-circle">
                                    <a href="index.php?url=addnewtoko"><i class="fas fa-plus text-lg opacity-10" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-6 mb-2">
                    <div class="card">
                        ...
                        <div class="card-body pt-0 p-3 text-center">
                            ...
                            <a class="btn btn-primary edit-link" href="?url=edit" data-id="<?= $list['idt']; ?>" data-it="<?= $list['idp']; ?>">
