...
if ($_SESSION['role'] != 'supertoko') {
  ...
  echo "<script>
    ...
    alert('Maaf Anda Bukan Sesi Super Toko');
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === '') ? 'import' : ''; ?>" href="index.php?url=import">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === '') ? 'kelompok' : ''; ?>" href="index.php?url=kelompok">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'ds') ? 'active' : ''; ?>" href="index.php?url=ds">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-clipboard-list text-info text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Request DS</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'prepare') ? 'active' : ''; ?>" href="index.php?url=prepare">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="far fa-clipboard text-primary text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Request Prepare</span>
          </a>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">History</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'historyds') ? 'active' : ''; ?>" href="index.php?url=historyds">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-history text-secondary text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">History DS</span>
          </a>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Approval</h6>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($_GET['url'] === 'mutasi') ? 'active' : ''; ?>" href="index.php?url=mutasi">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-plus text-sm opacity-10" style="color: purple;"></i>
            </div>
